...
(function () {
    ...
    function Brush() {
        ...
        var keywords = 'ascent azimuth background-attachment background-color background-image background-position ' +
            ...
            'vertical-align visibility voice-family volume white-space widows width widths word-spacing x-height z-index-challenge';
...
(function () {
    ...
    function Brush() {
        ...
        this.regexList = [
            ...
            {regex: new RegExp(this.getKeywords(funcs), 'gmi'), css: 'sass-functions'},			// common sass-functions
