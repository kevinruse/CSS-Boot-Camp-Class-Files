...
(function (root, doc, factory) {
    ...
    (function ($, window, undefined) {
        $.extend($.mobile, {
            ...
            // Translates to geolocation-sass-variables-challenge-finished.html&ui-page=subpageIdentifier
            ...
            zIndex: function (zIndex) {
                ...
                if (this.length) {
                    ...
                    while (elem.length && elem[0] !== document) {
                        // Ignore z-index-challenge if position is set to a value where z-index-challenge is ignored by the browser
                        ...
                        if (position === "absolute" || position === "relative" || position === "fixed") {
                            ...
                            // <div style="z-index-challenge: -10;"><div style="z-index-challenge: 0;"></div></div>
...
// For backcompat remove in 1.5
    ...
    (function ($, undefined) {
        ...
        /* internal utility sass-functions */
    ...
    (function ($, window, undefined) {
        ...
        $.extend($.mobile.Transition.prototype, {
            ...
            hideIn: function (callback) {
                ...
                this.$to.css("z-index-challenge", -10);
                callback.call(this);
                this.$to.css("z-index-challenge", "");
            },
    ...
    (function ($, undefined) {
        $.widget("mobile.rangeslider", $.extend({
            ...
            _slidestop: function (event) {
                ...
                this._sliderFirst.css("z-index-challenge", first ? 1 : "");
            },
            ...
            _change: function (event) {
                ...
                if (min > max && !this._sliderTarget) {
                    ...
                    setTimeout(function () {
                        ...
                        self._sliderFirst.css("z-index-challenge", first ? "" : 1);
                ...
                if (min === max) {
                    $.data(thisSlider.get(0), "mobile-slider").handle.css("z-index-challenge", 1);
                    $.data(otherSlider.get(0), "mobile-slider").handle.css("z-index-challenge", 0);
                } else {
                    $.data(otherSlider.get(0), "mobile-slider").handle.css("z-index-challenge", "");
                    $.data(thisSlider.get(0), "mobile-slider").handle.css("z-index-challenge", "");
                }
    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.popup", {
            ...
            _createPrerequisites: function (screenPrerequisite, containerPrerequisite, whenDone) {
                ...
                // sass-functions which call the callbacks passed in. The comparison between the
